          ...
          <div className="section-shell">
            ...
            <div className="mode-showcase">
              {GAME_MODES.map((mode, index) => (
                <Reveal key={mode.id} delay={index * .08}><motion.article className="mode-card" whileHover={{ y: -8 }} style={{ '--mode-accent': mode.accent } as React.CSSProperties}>
