...
// stable domain tokens, applying a small curated overlay for the two things no
// provider supplies.

import type { ClubIdentityTokens, ClubKitPattern } from './clubIdentityTypes'
 ...
 * three significant words. Generic legal suffixes such as FC/AFC are dropped.
 */
