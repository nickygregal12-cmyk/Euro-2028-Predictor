...
describe('ProfileScreen — full', () => {
  ...
  it('renders unavailable sources without inventing zero points, no leagues or an empty breakdown', () => {
    render(
      <ProfileScreen
        kind="full"
        header={{
        ...
        events={null}
        availability={{ leaderboard: false, leagues: false, scoreEvents: false }}
        locked
      />,
    )
