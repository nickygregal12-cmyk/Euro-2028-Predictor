...
describe('production backup workflow', () => {
  ...
  it('verifies restored migration history at the contract-55 head', () => {
    expect(workflow).toContain("EXPECTED_MIGRATION_COUNT: '55'")
    expect(workflow).toContain(
