...
The repository is at **contract 77** through `20260804043000_season_cup_sources.sql`, merged on `main`. Development Supabase is hosted at contract 76; production remains at 63. The repository contract and the hosted contracts are distinct facts. Any hosted schema mutation requires the guarded rollout workflow, explicit owner approval and the applicable preflight.
