...
The repository is at **contract 73** through `20260804003000_lms_round_conclusion.sql`, merged on `main`. Development Supabase is hosted at contract 72; production remains at 63. The repository contract and the hosted contracts are distinct facts. Any hosted schema mutation requires the guarded rollout workflow, explicit owner approval and the applicable preflight.
