...
**Next up:** Tier 2 / Phase 1 — server-enforced score lock at tournament kickoff, flat overall leaderboard. Real auth screens per auth-plan Phase 1 exit. See `docs/build-todo.md`.
