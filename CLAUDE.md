...
**Next up:** Tier 2 / Phase 1 — review & submit, awards/bonus screen, server-enforced score lock at kickoff. Real auth screens per auth-plan Phase 1 exit. See `docs/build-todo.md`.
