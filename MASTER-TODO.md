...
- [ ] Adopt `Workspace` on the remaining COMPETITION sections where desktop genuinely gains a second column — Last Man Standing beside club form, the Championship beside its group table. Matches and the season Leagues page were reviewed and take none: a fixture list is a reading column, and the league page's second column is the Matchweek/Members work below.
- [ ] Give the desktop rail a gallery visual baseline (needs a GitHub runner dispatch).
