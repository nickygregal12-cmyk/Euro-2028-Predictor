...
- [x] Implement the private nine-league AI Lab and paid-odds custody boundary in the repository (contract 185, ADR 0029): free Football-Data.co.uk history/fixture prices, canonical `ai.fixtures`, paper value/settlement/CLV, immutable artefacts and secret-safe budgeted Odds API snapshots. Collection is installed disabled and no hosted rollout is claimed. SportDB.dev remains behind the existing capability/licensing audit rather than becoming a fourth result authority because a secret exists.
