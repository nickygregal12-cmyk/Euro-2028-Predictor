...
- [ ] Visual and performance evidence around the new foundation: Playwright screenshot contracts (fixed time/fixtures; light/dark, phone/desktop, reduced motion) and Lighthouse CI with route-specific budgets — including the investigation of the design preview's performance-20 score before any prototype pattern becomes a production primitive.
