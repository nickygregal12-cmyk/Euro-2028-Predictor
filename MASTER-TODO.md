...
- [ ] Remove the three confirmed-dead symbols the baseline names (`fetchLastSeen`, `fetchEntrySubmissionStatus`, `PredictIcon`) in one small dedicated PR where the deletion is the reviewable subject.
