...
- [x] **`UI-F18` responsive sweep.** Seven widths, both themes, measured for overflow, tap-target height and the 1024px rail handover. No overflow anywhere; three Match Centre topbar controls were under 44px and are fixed.
