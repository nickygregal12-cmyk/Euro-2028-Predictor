...
| | Contract | Detail |
| --- | ---: | --- |
| Repository | **206** | latest `20260819110000_same_season_player_profile.sql` |
...
**Pending development migrations:** 1 — `20260819110000_same_season_player_profile.sql`

**Next free contract number:** 207. Check open pull requests
