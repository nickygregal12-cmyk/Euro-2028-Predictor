...
**43** accepted requirements are outstanding, of which **8** are blocked — ACCOUNT 5, AGE 1, AUTH 1, CAP 5, DFA 10, INGEST 4, MIG-UI 5, PRIV 5, SITE 7. A further 22 are marked implemented and retained in the register.
