...
| | Contract | Detail |
| --- | ---: | --- |
| Repository | **207** | latest `20260819130000_cup_bracket_outcome_and_knockout_stage.sql` |
...
**Pending development migrations:** 2 — `20260819120000_cup_phase_determinate_membership.sql`, `20260819130000_cup_bracket_outcome_and_knockout_stage.sql`
