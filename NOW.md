...
| | Contract | Detail |
| --- | ---: | --- |
| Repository | **191** | latest `20260817120000_season_player_identity.sql` |
...
**Pending development migrations:** 2 — `20260814005000_ai_actionable_bet_evidence.sql`, `20260817120000_season_player_identity.sql`

**Next free contract number:** 192. Check open pull requests
...
**64** accepted requirements are outstanding, of which **13** are blocked — ACCOUNT 5, AGE 1, AUTH 1, CAP 4, CUP 3, DFA 10, INGEST 1, INNOV 20, LMS 1, MIG-UI 5, PRIV 5, PROF 1, SITE 6, TABLE 1. A further 38 are marked implemented and retained in the register.
