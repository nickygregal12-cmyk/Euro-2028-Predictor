...
| | Contract | Detail |
| --- | ---: | --- |
| Repository | **194** | latest `20260817150000_cup_tie_eligibility.sql` |
...
**Pending development migrations:** 5 — `20260814005000_ai_actionable_bet_evidence.sql`, `20260817120000_season_player_identity.sql`, `20260817130000_season_rank_history_and_rivalry.sql`, `20260817140000_season_cup_bracket_read.sql`, `20260817150000_cup_tie_eligibility.sql`

**Next free contract number:** 195. Check open pull requests
