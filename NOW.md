...
| | Contract | Detail |
| --- | ---: | --- |
| Repository | **212** | latest `20260820130000_matchweek_card_publishes_the_fixture_lock.sql` |
...
**Pending development migrations:** 1 — `20260820130000_matchweek_card_publishes_the_fixture_lock.sql`

**Next free contract number:** 213. Check open pull requests
