...
| | Contract | Detail |
| --- | ---: | --- |
| Repository | **135** | latest `20260809040000_euro_publication_state.sql` |
...
**Pending development migrations:** 2 — `20260809030000_rate_limit_events_client_revoke.sql`, `20260809040000_euro_publication_state.sql`

**Next free contract number:** 136. Check open pull requests
