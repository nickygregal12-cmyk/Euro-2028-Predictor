...
> **Contract 207 stage effect:** the bracket read states the caller's own outcome and stops offering a split fixture as a knockout tie. No hub build-stage scope changes.

> **Contract 206 stage effect:** the phase read answers about a split entrant's current group rather than their pre-split one. No hub build-stage scope changes.
