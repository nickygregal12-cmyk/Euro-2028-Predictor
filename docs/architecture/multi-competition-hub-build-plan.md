...
> **Contract 207 stage effect:** every hub surface that draws a fixture gains a real abnormal state to draw. No hub build-stage scope changes; the state arrives on the existing fixture reads.
