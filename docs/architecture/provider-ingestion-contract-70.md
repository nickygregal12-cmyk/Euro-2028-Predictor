# Provider ingestion contract 70
...
Contract 70 adds the minimum safe custody boundary for external football fixture and result providers. It follows contract 69's domestic season card. Provider evidence remains separate from application fixture and result authority.
...
Provider custody was originally prepared while contracts 68 and 69 were being claimed by concurrent work. Contract 68 became the season-fixture container and contract 69 became the season card. Contract 70 is rebuilt from the exact merged contract-69 head and preserves both migrations unchanged.
...
A first hosted Development poll requires a separate guarded rollout after contracts 69 and 70 are hosted, the named key and provider secret are configured, and unauthorised access is proved against the hosted function. Production remains prohibited.
