...
**Status:** Contract 143 candidate — repository only, not hosted  
...
Contract 143 does **not** change Hub catalogue entries, navigation, routes, metadata, sitemap or Open Graph output. Those are EURO-003/EURO-004 enforcement consumers and must follow this state rather than create another visibility authority.
