...
The repository and development are level at **contract 93**.

| Environment | Contract | Evidence | Status |
| --- | ---: | --- | --- |
| Repository `main` | **93** | Contract 92 makes `carried_to_replay` reachable from stored data and contract 93 is the scoring job that writes the first season points total, through `20260804213000_season_matchweek_scoring_job.sql` | MERGED AND APPLIED |
...
Contracts 64–93 are all applied to development. None is authorised for production merely to remove the intentional contract gap.
