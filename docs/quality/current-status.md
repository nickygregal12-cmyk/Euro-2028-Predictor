...
| Account deletion | **Unsafe current behaviour, fully characterised and owned by C2.** PR #246 pins the before-state. No ownership/deletion change may enter C1; issue #272 remains the blocker. |
...
| Stage C1 | **Approved to proceed through design/contract reconciliation.** No migration or hosted write exists. Issue #303 is the next executable slice. |
