...
| Repository contract | **79** — 79 canonical migrations through `20260804063000_cup_store_competition_domains.sql`. Development Supabase is hosted at **78** (contract 66 applied 3 August 2026 through the ADR 0024 fast lane, run 30837677979; contract 67 run 30840592967 and contract 68 run 30843028463 and contract 69 run 30845804899 and contract 70 run 30847250038 and contract 71 run 30848868220 and contract 72 run 30852527116 and contract 73 run 30853872967 and contract 74 run 30855978136 and contract 75 run 30859357998 and contract 76 run 30860514107 and contract 77 run 30862293279 and contract 78 run 30863384885, all the same day); production remains at **63**. The repository leads development by one additive migration until the next fast-lane run. The contract 77 rollout was initially missed — work moved straight from that merge into the next slice — and the inventory briefly claimed an apply that had not happened; the cross-document guard added at contract 78 exists because of it. Non-production Netlify contexts carry `EURO28_DEPLOYED_DB_CONTRACT` from the last alignment and report any gap as informational rather than failing the build (ADR 0024); production keeps the fatal check |
