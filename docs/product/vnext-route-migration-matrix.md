...
| `/welcome` | `WelcomePage` | First sign-in | `RequireWelcome` | Onboarding | 9+ | **REDESIGN** | The full onboarding flow (`DFA-001`, `DFA-002`) remains accepted and unbuilt. §4 of this matrix's companion audit. |
