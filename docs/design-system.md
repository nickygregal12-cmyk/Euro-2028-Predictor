...
### Matches tab (5th nav slot — expansion into the during-tournament command centre decided 2026-07-22; ONLY the Fixtures sub-view is built today)
The answer to "what's happening, and how am I doing against it". A **segmented control at the top** switches four sub-views (the fixtures list shipped 2026-07-21 becomes the first of them; Tables, Bracket and Stats are unbuilt):
