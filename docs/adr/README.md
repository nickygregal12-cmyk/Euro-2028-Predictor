...
| [0020](0020-football-prediction-hub-product-model.md) §Ingestion | Provider ingestion and notifications | Accepted — **the identity map it needs is merged at Contract 112**; the automatic fixture import and administrative reassignment the ADR decides on remain unbuilt, and depend on a round-window authority that does not yet exist |
