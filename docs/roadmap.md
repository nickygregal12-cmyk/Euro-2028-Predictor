...
- [~] **Auth hardening** (one combined build) — pure-code items + SMTP + Turnstile all done and live; password reset ready to build + the email-verification decision remain:
