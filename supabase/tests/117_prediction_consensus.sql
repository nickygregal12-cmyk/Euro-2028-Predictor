...
insert into public.match_predictions (
  tournament_id, entry_id, match_id, home_score, away_score
) values
  ('61000000-0000-0000-0000-000000000001', '61000000-0000-0000-0002-000000000001', '61000000-0000-0000-0000-000000000201', 2, 0),
  ('61000000-0000-0000-0000-000000000001', '61000000-0000-0000-0002-000000000001', '61000000-0000-0000-0000-000000000202', 1, 1),
  ('61000000-0000-0000-0000-000000000001', '61000000-0000-0000-0002-000000000002', '61000000-0000-0000-0000-000000000201', 2, 0),
  ('61000000-0000-0000-0000-000000000001', '61000000-0000-0000-0002-000000000002', '61000000-0000-0000-0000-000000000202', 2, 1),
  ('61000000-0000-0000-0000-000000000001', '61000000-0000-0000-0002-000000000003', '61000000-0000-0000-0000-000000000201', 9, 9);

insert into public.predicted_progression (
  tournament_id, entry_id, team_id, stage
) values
  ('61000000-0000-0000-0000-000000000001', '61000000-0000-0000-0002-000000000001', '61000000-0000-0000-0000-000000000101', 'champion'),
  ('61000000-0000-0000-0000-000000000001', '61000000-0000-0000-0002-000000000001', '61000000-0000-0000-0000-000000000102', 'final'),
  ('61000000-0000-0000-0000-000000000001', '61000000-0000-0000-0002-000000000002', '61000000-0000-0000-0000-000000000101', 'champion'),
  ('61000000-0000-0000-0000-000000000001', '61000000-0000-0000-0002-000000000002', '61000000-0000-0000-0000-000000000103', 'final'),
  ('61000000-0000-0000-0000-000000000001', '61000000-0000-0000-0002-000000000003', '61000000-0000-0000-0000-000000000104', 'champion');
