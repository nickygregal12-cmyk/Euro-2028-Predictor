-- Contract 134: provider team profile enrichment foundation.
--
...
--
-- Provider image URLs are retained as evidence/reference only. Contract 134 does
...
comment on table predictor_internal.provider_team_profiles is
  'Contract 134. Server-only current provider profile facts for an already-mapped team. Provider media fields are reference/provenance only and are not public-display authority.';
